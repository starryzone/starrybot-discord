    ...
    getConfig: async (state) => {
      ...
      return {
        ...
        prompt: {
          ...
          footer: selectedRole.count_staked_only ?
            'If you select "No" it will count liquid, staked, and currently unbonding where applicable. If you select "Yes", there will be no change.' :
            'If you select "Yes", it will count staked tokens only. If you select "No", there will be no change.',
        }
      }
    }
  }
